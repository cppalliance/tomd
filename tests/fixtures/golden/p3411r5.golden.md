...
- Performance tests update
  - All benchmarks use -O3 (as requested in Wroc&lstrok;aw)
  - For eager algorithms, do not use ranges at all (as requested in Wroc&lstrok;aw)
...
In Wroc&lstrok;aw meeting, one important point was made: The majority of the use case of `any_view` is to use it as a function parameter in the API boundary.
...
In Wroc&lstrok;aw meeting, one feedback we had was to explore the options to have &#8220;single expansion point&#8221;, i.e not to have too many template parameters
